                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <form role="form" action="{{ route('permission.edit.store') }}" method="post">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                        <label for="name">权限名：</label>
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $id->name }}" placeholder="请输入权限名称">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-warning" onclick="goPath('{{ route('permission') }}')">返回</button>
                                </form>
                            </div>
                        </div>
                        <!-- END INPUTS -->
